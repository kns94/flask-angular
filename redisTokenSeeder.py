...
class RedisTokenSeed(object):
    ...
    def putTokens(self):
        ...
        """
        RedisCache.createHash('dataset_map','people_killed_parisBombing', {'dataset_url': 'https://docs.google.com/spreadsheets/d/1BIUVypETaWmTCxfkvCcZlkAh4bNUP8zA94r7jPjBzbE/export?format=csv', 'dataset_id': None})
